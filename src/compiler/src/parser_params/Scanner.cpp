...
void Scanner::Init() {
	...
	for (i = 48; i <= 57; ++i) start.set(i, 26);
	start.set(39, 2);
	start.set(34, 5);
	start.set(46, 13);
	start.set(45, 39);
		start.set(Buffer::EoF, -1);
	keywords.set(L"ALL", 9);
	keywords.set(L"WARN", 10);
	keywords.set(L"ERR", 11);
	keywords.set(L"json", 13);
	keywords.set(L"protobuf", 14);
	keywords.set(L"plaint", 15);
...
Token* Scanner::NextToken() {
	...
	switch (state) {
		...
		case 6:
			case_6:
			if ((ch >= L'0' && ch <= L'3')) {AddCh(); goto case_27;}
		...
		case 27:
			...
			else if ((ch >= L'0' && ch <= L'7')) {AddCh(); goto case_28;}
			else if (ch == L'"') {AddCh(); goto case_12;}
			else if (ch == 92) {AddCh(); goto case_6;}
			else {goto case_0;}
		case 28:
		...
		case 32:
			case_32:
			if (ch == L'y') {AddCh(); goto case_33;}
			else {goto case_0;}
		case 33:
			case_33:
			if (ch == L'p') {AddCh(); goto case_34;}
			else {goto case_0;}
		case 34:
			case_34:
		...
		case 39:
			...
			else if (ch == L'o') {AddCh(); goto case_30;}
			else if (ch == L'd') {AddCh(); goto case_31;}
			else if (ch == L't') {AddCh(); goto case_32;}
			else if (ch == L'r') {AddCh(); goto case_36;}
			else {goto case_0;}
